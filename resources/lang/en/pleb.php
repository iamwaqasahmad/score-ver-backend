...
return [
    ...
    'mail' => [
        ...
        'Verify Paragraph'  => 'Please, use the following code to verify your account.',
        ...
        'accept_invitation Paragraph'  => 'Please, login your account to check the details.',

        'accept_request title' => 'An admin accepted your request',
        'accept_request Paragraph'  => 'Please, login your account to check the details.',
    ],
